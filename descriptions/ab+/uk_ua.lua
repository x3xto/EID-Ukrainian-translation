...
EID.descriptions[languageCode].collectibles={
	...
	{"94", "Мішечок пенні", "{{Coin}} Створює випадкову монету кожні 2 кімнати"},
	...
	{"139", "Матусина сумочка", "{{Trinket}} Персонаж може тримати 2 брелоки"},
	...
	{"315", "Дивна принада", "Сльози персонажа притягують ворогів, розхідники та брелоки"},
	...
	{"347", "Диплопія", "{{Warning}} ОДНОРАЗОВИЙ {{Warning}}#Дублює всі п'єдестали, розхідники, скрині та брелоки в кімнаті"},
	...
	{"439", "Матусина коробка", "{{Trinket}} Створює випадковий брелок#Поки ви тримаєте цей предмет, подвоює ефекти брелоків#↑ {{Luck}} +1 Удача, поки ви тримаєте цей предмет"},
	...
	{"458", "Пупок", "{{Trinket}} Дозволяє персонажу одночасно тримати 2 брелоки#{{Trinket}} Створює випадковий брелок"},
	...
	{"479", "Плавильня", "{{Trinket}} Поглинає брелок персонажа та дає перманентний ефект від цього брелока#Збільшує частоту появи брелоків"},
	...
	{"500", "Мішечок з мішечками", "Створює мішечок кожні 5-6 кімнат"},
	...
	{"532", "Сльозотеча", "Сльози персонажа поступово сповільнюються, зупиняються, а тоді розриваються на 8 менших#Сльози можуть об'єднуватись та ставати більшими"},
	...
	{"538", "Камінці", "{{Trinket}} Створює 3 випадкові брелоки#{{Collectible479}} При отриманні шкоди, активний брелок може бути поглинутий та перенесений до інвентарю предметів, перманентно даючи свій ефект"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"75", "Помилка", "Ефект випадкового брелока для кожної кімнати"},
...
EID.descriptions[languageCode].dice={
	...
	{"3", "", "Реролить усі розхідники та брелоки на поверсі#Не впливає на кімнати {{DevilRoom}}Диявола чи {{AngelRoom}}Ангела"},
	...
	{"6", "", "Реролить усі предмети персонажа#Реролить усі розхідники, брелоки та п'єдестальні предмети на поверсі"},
}
